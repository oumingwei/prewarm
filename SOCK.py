        ...
        for f in range(len(self.function_list)):
            while sum(y[f][k]for k in range(len(self.node_list))) != 1:
                for n in range(len(self.node_list)):
                    ...
                    if y[f][n] == 1:
                        if self.node_list[n].cpu_resources >= self.function_list[f].cpu_resource_need * self.function_list[f].request_rate:
                            self.node_list[n].cpu_resources -= self.function_list[f].cpu_resource_need * self.function_list[f].request_rate
